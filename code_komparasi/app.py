...
def gambarkan_komparasi_zscore_timeline(df_raw, ticker):
    # Buat subplot 2 baris, 1 kolom agar perbandingan tampil atas-bawah
    ...
    # ----------------------------------------------------
    # BAWAH: SESUDAH STANDARDISASI (X = Z-SCORE, Y = TANGGAL)
    # ----------------------------------------------------
...
if menu_select == "A. Standardisasi & Pivot Points":
    ...
    if matched_files:
        ...
        # Tampilan tabel sampel data dan grafik runut waktu harian secara berurutan ke bawah
